...
<% int monthValue = Integer.parseInt((String.valueOf(session.getAttribute("MonthRequest"))))+1;%>
<% List<Integer> months = util.getMonthsTrans(cUser.getIdUser());%>
<% List<Transactions> transactions = transRepo.GetTransactionsPerMonth(monthValue, cUser.getIdUser());%>
<% double balance = transRepo.GetBalancePerMonth(monthValue, cUser.getIdUser());%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body background="resources/trama.jpg">
        ...
        <div class="card white darken-1">
            <div class="card-content black-text">
                <span class="card-title">Historial de <%=util.getMonthName(monthValue-1)%></span>
            ...
            <div class="card-content black-text">
                ...
                <div class="row col s12">
                    <div class="col s4">
                        ...
                        <h4><font color="green">S/.<%=transRepo.GetIncomes(monthValue, cUser.getIdUser())%></font></h4>
                    </div>
                    <div class="col s4">
                        <h5>Total Salidas</h5>
                        <h4><font color="red">S/.<%=transRepo.GetExpenses(monthValue, cUser.getIdUser())%></font></h4>
                    </div>
                    <div class="col s4">
                        <h5>Balance</h5>
                        <%if (balance<0){%>
