 ...
 * @author Hugo
 */
@WebServlet(name = "MonthHistory", urlPatterns = {"/MonthHistory"})
public class MonthHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MonthHistory</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MonthHistory at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
